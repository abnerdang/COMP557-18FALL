...
public class Parser {
	...
	public static DAGNode createJoint( Node dataNode ) {
		...
		}else if (type.equals("LShoulderJoint")) {
			LShoulderJoint joint = new LShoulderJoint( name );
			joint.setPosition( getTuple3dAttr(dataNode,"position") );
			return joint;
		}else if(type.equals("RShoulderJoint")){
			RShoulderJoint joint = new RShoulderJoint( name );
			joint.setPosition( getTuple3dAttr(dataNode,"position") );
			return joint;
		}else if(type.equals("NeckJoint")) {
			NeckJoint joint =new NeckJoint( name );
			joint.setPosition( getTuple3dAttr(dataNode,"position"));
			joint.setAxis( getTuple3dAttr(dataNode,"axis") );
			return joint;
		}else if(type.equals("ElbowJoint")) {
			ElbowJoint joint =new ElbowJoint( name );
			joint.setPosition( getTuple3dAttr(dataNode,"position"));
			joint.setAxis( getTuple3dAttr(dataNode,"axis") );
			return joint;
		}else if(type.equals("KneeJoint")) {
			KneeJoint joint =new KneeJoint( name );
			joint.setPosition( getTuple3dAttr(dataNode,"position"));
			joint.setAxis( getTuple3dAttr(dataNode,"axis") );
			return joint;
		}
